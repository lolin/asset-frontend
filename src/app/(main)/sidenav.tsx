...
export default function Sidenav() {
  ...
  return (
    ...
    //   <ul className="text-gray-400 pt-20 ml-8">
    //     <Link href="/dashboard">
    //       <li
    //         className={`mb-2 ${
    ...
    //       <li
    //         className={`mb-2 ${
    //           pathname === "/conditions" ? "text-white" : ""
    //         } cursor-pointer hover:text-white`}
    //       >
    //         Condition Type
    //       </li>
    ...
    //       <li
    //         className={`mb-2 ${
    //           pathname === "/departments" ? "text-white" : ""
    //         } cursor-pointer hover:text-white`}
    //       >
    //         Department
    //       </li>
